...
const collections: Collection[] = [
  {
    ...
    description:
      "Celestial designs inspired by cosmic energies and astrological wisdom",
    image:
      "https://cdn.builder.io/o/assets%2F47ddcd4c543e4e54b99a663aa4332592%2F383abc00c01a4a66818a6d3d7e884f43?alt=media&token=ec909a40-5912-4d43-a727-bb8dfceb92c9&apiKey=47ddcd4c543e4e54b99a663aa4332592",
  ...
  },
  {
    ...
    description:
      "Royal elegance meets contemporary design with precious emeralds",
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-collection.jpg?width=400",
  ...
  },
  {
    ...
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-collection.jpg?width=400",
  ...
  },
  {
    ...
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-collection.jpg?width=400",
  ...
  },
  {
    ...
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-collection.jpg?width=400",
  ...
  },
  {
    ...
    image:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/celestial-collection.jpg?width=400",
      ...
      <section className="relative bg-gray-100 py-16 md:py-24">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
            All collections from MYTHARA - Discover our curated selection of
          ...
          <div className="flex flex-col md:flex-row items-center bg-gray-50 rounded-lg overflow-hidden shadow-md">
            ...
            <div className="md:w-1/2 p-8 md:p-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                Explore ASTRO Collection
              </h2>
              <p className="text-gray-600 mb-6">
                Journey into the astrological realm with our premium collection
                of celestial-inspired jewelry that captures the essence of
                cosmic energy and stellar beauty.
              </p>
              <a
                href="/collections/astro"
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Get access to special offers, new collection launches, and exclusive
            jewelry insights.
          </p>
