...
const jewelleryCategories: { [key: string]: JewelleryCategory } = {
  earrings: {
    ...
    description: 'Elegant earrings that frame your face beautifully, from delicate studs to statement chandelier designs.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/earrings-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.8,
        reviews: 24,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-drop-earrings.jpg?width=400',
        secondaryImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-drop-earrings-alt.jpg?width=400',
        description: 'Exquisite emerald drop earrings with intricate gold detailing'
      },
      {
        ...
        rating: 4.9,
        reviews: 18,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-chandelier-earrings.jpg?width=400',
        description: 'Stunning ruby chandelier earrings perfect for special occasions'
      },
      {
        ...
        rating: 4.7,
        reviews: 32,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-stud-earrings.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.6,
        reviews: 21,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-hoop-earrings.jpg?width=400',
      ...
      },
      {
        ...
        rating: 5.0,
        reviews: 12,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/diamond-cluster-earrings.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.5,
        reviews: 28,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-geometric-earrings.jpg?width=400',
  ...
  rings: {
    ...
    description: 'Exquisite rings that tell your story, from engagement rings to everyday statement pieces.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/rings-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.9,
        reviews: 15,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-solitaire-ring.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 19,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-vintage-ring.jpg?width=400',
      ...
      },
      {
        ...
        rating: 5.0,
        reviews: 8,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-engagement-ring.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.6,
        reviews: 22,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-cocktail-ring.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.9,
        reviews: 11,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/diamond-eternity-ring.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.4,
        reviews: 26,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-signet-ring.jpg?width=400',
  ...
  lockets: {
    ...
    description: 'Meaningful lockets and pendants that keep your treasured memories close to your heart.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/lockets-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.7,
        reviews: 20,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-heart-pendant.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 17,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-star-locket.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.9,
        reviews: 14,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-moon-pendant.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.6,
        reviews: 23,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-flower-locket.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 12,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/diamond-cross-pendant.jpg?width=400',
        description: 'Elegant diamond cross pendant with spiritual significance'
      },
      {
        ...
        rating: 4.5,
        reviews: 29,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-infinity-pendant.jpg?width=400',
        description: 'Minimalist gold infinity pendant representing eternal love'
      }
    ]
  }
};
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 mb-8">The jewelry category you're looking for doesn't exist.</p>
