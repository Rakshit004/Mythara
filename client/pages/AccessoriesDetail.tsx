...
const accessoryCategories: { [key: string]: AccessoryCategory } = {
  cufflinks: {
    ...
    description: 'Sophisticated cufflinks that add elegance and refinement to formal attire.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/cufflinks-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.8,
        reviews: 14,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-square-cufflinks.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.7,
        reviews: 18,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-round-cufflinks.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.9,
        reviews: 12,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-oval-cufflinks.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.5,
        reviews: 22,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-geometric-cufflinks.jpg?width=400',
  ...
  bracelets: {
    ...
    description: 'Stunning bracelets that adorn your wrist with grace and sophistication.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/bracelets-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.9,
        reviews: 16,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-tennis-bracelet.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.7,
        reviews: 21,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-charm-bracelet.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 13,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-bangle-set.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.6,
        reviews: 28,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-strand-bracelet.jpg?width=400',
  ...
  brooches: {
    ...
    description: 'Exquisite brooches that make a statement and showcase your personal style.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/brooches-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.8,
        reviews: 15,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-flower-brooch.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.7,
        reviews: 19,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-butterfly-brooch.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.9,
        reviews: 11,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-vintage-brooch.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.5,
        reviews: 24,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/pearl-feather-brooch.jpg?width=400',
  ...
  'tie-pins': {
    ...
    description: 'Refined tie pins that add sophistication and character to your formal wear.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/tie-pins-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.6,
        reviews: 17,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-classic-tie-pin.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.7,
        reviews: 14,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-vintage-tie-pin.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 12,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-modern-tie-pin.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.4,
        reviews: 26,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-minimalist-tie-pin.jpg?width=400',
  ...
  'belt-buckles': {
    ...
    description: 'Distinctive belt buckles that serve as the perfect finishing touch to your ensemble.',
    bannerImage: 'https://cdn.builder.io/api/v1/image/assets/TEMP/belt-buckles-banner.jpg?width=1200',
    products: [
      {
        ...
        rating: 4.7,
        reviews: 13,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/emerald-square-buckle.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.8,
        reviews: 16,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/ruby-oval-buckle.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.9,
        reviews: 10,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/sapphire-rectangular-buckle.jpg?width=400',
      ...
      },
      {
        ...
        rating: 4.5,
        reviews: 21,
        image: 'https://cdn.builder.io/api/v1/image/assets/TEMP/gold-engraved-buckle.jpg?width=400',
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-gray-600 mb-8">The accessory category you're looking for doesn't exist.</p>
          <Link to="/" className="bg-black text-white px-6 py-3 rounded-md hover:bg-gray-800 transition duration-300">
            Back to Home
          </Link>
        </div>
        <Footer />
