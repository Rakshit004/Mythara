            ...
            {messages.length === 0 ? (
              <div className="text-center text-gray-500 mt-8">
                ...
                <p className="text-sm mt-2">
                  Ask me about astrology and how our jewelry can enhance your
                  cosmic energy.
                </p>
              </div>
            ) : (
                ...
                >
                  <div
                    className={`inline-block max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                      message.isUser ? "bg-black text-white" : "bg-white border"
                    }`}
                  >
                    <p className="text-sm">{message.text}</p>
                    <p
                      className={`text-xs mt-1 ${message.isUser ? "text-gray-300" : "text-gray-500"}`}
                    >
