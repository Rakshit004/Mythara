      ...
      <header className="sticky top-0 z-50 bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8 mx-auto">
            ...
            {/* Jewellery Dropdown */}
            <div className="dropdown relative">
              <span className="nav-link cursor-pointer">JEWELLERY</span>
            ...
            <div className="dropdown relative">
              <span className="nav-link cursor-pointer">ACCESSORIES</span>
              <div className="dropdown-menu absolute hidden bg-white shadow-lg rounded mt-2 py-2 w-48 z-50">
                <Link
                  to="/accessories/cufflinks"
                  className="block px-4 py-2 hover:bg-gray-100"
                >
                  Cufflinks
                </Link>
                <Link
                  to="/accessories/bracelets"
                  className="block px-4 py-2 hover:bg-gray-100"
                >
                  Bracelets
                </Link>
                <Link
                  to="/accessories/brooches"
                  className="block px-4 py-2 hover:bg-gray-100"
                >
                  Brooches
                </Link>
                <Link
                  to="/accessories/tie-pins"
                  className="block px-4 py-2 hover:bg-gray-100"
                >
                  Tie Pins
                </Link>
                <Link
                  to="/accessories/belt-buckles"
                  className="block px-4 py-2 hover:bg-gray-100"
                >
                  Belt Buckles
                </Link>
